...
class AppTheme {
  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      appBarTheme: AppBarTheme(
        ...
        iconTheme: IconThemeData(color: ColorScheme.fromSeed(seedColor: _seedColor).onSurface),
      ),
  ...
  static TextTheme _buildTextTheme(Brightness brightness) {
    return GoogleFonts.notoSansTextTheme(
      TextTheme(
        displayLarge: TextStyle(fontSize: 57, fontWeight: FontWeight.w400, letterSpacing: 0, height: 1.12),
